...
public class BdProductos {
    ...
    public static List<Producto> products = getProducts();
    ...
    public static List<Producto> getProducts(){
        ...
        Producto producto17 = new Producto(17L, "Portátil Ultraligero 'Productoividad Máxima'", 849.99, 60, "Un portátil ultraligero con un rendimiento máximo para aumentar tu productividad en cualquier lugar.");
    ...
    public static Producto getProductByName(String name){
        for (Producto product : products) {
            if (name.equals(product.getNombre())){
                return product;
            }
        }
        return null;
